...
export const AboutSections = [
    ...
    },
    {
        ...
        description:
            "Click on the link below to pull up your emailer auto addressed to me and I will be happy to add any helpful links",
        category: <p style={{ fontSize: '3rem' }}>🔗</p>,
        link: "mailto:benjahmin.lakin@gmail.com??subject=Link%20Submission%20for%20Vegan%20Link%20App",
    },
    {
        type: "About",
        name: "Who is Benjahmin Koenigsberg",
        description:"I am a vegan activist turned coder in 2023. I am excited to practice my coding skills while building projects that further veganism. Check out my porftolio website by clicking the link below. When I am not coding or doing activism, I enjoy eating whole plants and riding my bike",
        category: <p style={{ fontSize: '3rem' }}>✊🏻🧑🏻‍💻🌱🚲</p>,
        link: "https://www.benjahminkoenigsberg.com",
    },
    {
